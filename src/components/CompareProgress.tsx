import {View, Text, Button, Platform, TouchableOpacity, ScrollView} from 'react-native';
  ...
  return (
    ...
    <ScrollView>
      <View className='flex items-center'>
        <Text className="text-2xl font-bold text-center">Compare Progress</Text>
